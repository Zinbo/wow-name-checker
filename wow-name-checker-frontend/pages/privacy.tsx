export default function Privacy() {
    return (
        <>
            <h1>Privacy Policy for https://wownamechecker.com</h1>

            <p>At WoW Name Checker, accessible from https://wownamechecker.com, one of our main priorities is the
                privacy of our
                visitors. This Privacy Policy document contains types of information that is collected and recorded by
                WoW Name
                Checker and how we use it.</p>
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards
                to the information that they shared and/or collect in WoW Name Checker. This policy is not applicable to
                any
            ...
            <p>WoW Name Checker follows a standard procedure of using log files. These files log visitors when they
                visit
            ...
            <p>You may consult this list to find the Privacy Policy for each of the advertising partners of WoW Name
                Checker.</p>

            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in
                their respective advertisements and links that appear on WoW Name Checker, which are sent directly to
                users'
                browser. They automatically receive your IP address when this occurs. These technologies are used to
                measure the
                effectiveness of their advertising campaigns and/or to personalize the advertising content that you see
                on
                websites that you visit.</p>

            <p>Note that WoW Name Checker has no access to or control over these cookies that are used by third-party
                advertisers.</p>

            <h2>Third Party Privacy Policies</h2>

            <p>WoW Name Checker's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
                you to
            ...
            <p>WoW Name Checker does not knowingly collect any Personal Identifiable Information from children under the
                age of
